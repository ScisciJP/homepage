...
<div style="background-color:#4CAF50; color:white; padding:15px; text-align:center; border-radius:5px;">
  第4回 Science of Science 研究会を、2026年7月4日（土）、5日（日）@神戸大学にて開催いたします。<br>
  専用HPを作成しておりますので、詳細については、 <a href="https://sciscijp.github.io/scisciconfJP2026/" target="_blank" rel="noopener">こちら</a>からご覧ください。
</div>
...
Science of scienceについて、詳しくは[こちら]({{ site.baseurl }}/about)をご覧ください。
...
## 問い合わせ
会の開催その他、Science of Scienceの最新動向について週1回~2ヶ月に1度ほど配信している受信専用のメーリングリストをご用意しています。
メーリングリストへは[こちら](https://groups.google.com/g/science-of-science)からご登録いただけます。
